...
public class ToDoServiceImpl implements TodoService{
    ...
    public ResponseDto addTodo(RequestDto dto) { //투두 추가하기
        Todo todo = new Todo(dto.getUserName(), dto.getPassword(), dto.getTodo(), dto.getDoDate()); //투두 내역 받아서
        todoRepository.saveTodo(todo); //레포지토리에 넘겨주자
        return new ResponseDto(todo.getUserName(), dto.getTodo(), dto.getDoDate());
    }
}
